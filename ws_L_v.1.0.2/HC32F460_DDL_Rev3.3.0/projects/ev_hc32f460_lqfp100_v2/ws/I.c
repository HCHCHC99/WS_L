...
/* 2nd-order Butterworth IIR (fc=200Hz @ fs=50kHz design; actual sampling 25kHz -> real fc~100Hz, display only)
 ...
 *         Samples all 3 current channels for 500ms at ~25kHz, computes
