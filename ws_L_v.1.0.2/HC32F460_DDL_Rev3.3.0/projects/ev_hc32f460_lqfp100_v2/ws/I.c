...
/* 2nd-order Butterworth IIR (fc=200Hz @ fs=50kHz design; actual sampling 10kHz -> real fc~40Hz, display only)
 ...
 *         Samples all 3 current channels for 500ms at ~10kHz, computes
