...
/* ============================================================================
 * MotorScope RTT 心跳总开关（Keil Watch 可运行时修改 g_motor_scope）
 *   MOTOR_SCOPE_KEY = g_motor_scope 默认值：
 *     0 = 不发送 MOTF RTT 数据（省 CPU / 发布用）
 *     1 = 发送（调试默认）
 * ==========================================================================*/
#define MOTOR_SCOPE_KEY      1

/* MotorScope 发送节流参数（配合 g_motor_scope；时间/阈值可在此统一调整）：
